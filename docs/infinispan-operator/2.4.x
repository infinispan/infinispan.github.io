...
<title>Infinispan Operator 2.4 Guide</title>
...
<div id="header">
<h1>Infinispan Operator 2.4 Guide</h1>
...
<li><a href="#exchanging-service-account-tokens-cross-site">13.2.2. Exchanging service account tokens</a></li>
<li><a href="#exchanging-bound-service-account-tokens-cross-site">13.2.3. Exchanging bound service account tokens</a></li>
<li><a href="#applying-cluster-roles-xsite_cross-site">13.2.4. Setting up Kubernetes for managed cross-site connections</a></li>
<li><a href="#configuring-sites-automatically_cross-site">13.2.5. Configuring managed cross-site connections</a></li>
</ul>
</li>
...
<li><a href="#auto-scaling">16. Auto Scaling</a>
<ul class="sectlevel2">
<li><a href="#configuring_auto-scaling-scaling">16.1. Configuring HorizontalPodAutoscaler</a></li>
</ul>
</li>
<li><a href="#creating-caches">17. Creating caches with Infinispan Operator</a>
<ul class="sectlevel2">
<li><a href="#caches_creating-caches">17.1. Infinispan caches</a></li>
<li><a href="#creating-caches_creating-caches">17.2. Creating caches with the Cache CR</a></li>
<li><a href="#updating_cache_creating-caches">17.3. Updating caches with the Cache CR</a></li>
<li><a href="#adding-cache-stores_creating-caches">17.4. Adding persistent cache stores</a></li>
</ul>
</li>
<li><a href="#batch-cr">18. Running batch operations</a>
<ul class="sectlevel2">
<li><a href="#batching-inline_batch">18.1. Running inline batch operations</a></li>
<li><a href="#batching-create-configmap_batch">18.2. Creating ConfigMaps for batch operations</a></li>
<li><a href="#batching-configmap_batch">18.3. Running batch operations with ConfigMaps</a></li>
<li><a href="#batch-status_batch">18.4. Batch status messages</a></li>
<li><a href="#batch-operations_batch">18.5. Example batch operations</a>
<ul class="sectlevel3">
<li><a href="#_caches">18.5.1. Caches</a></li>
<li><a href="#_counters">18.5.2. Counters</a></li>
<li><a href="#_protobuf_schema">18.5.3. Protobuf schema</a></li>
<li><a href="#_tasks">18.5.4. Tasks</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#backing-up-restoring">19. Backing up and restoring Infinispan clusters</a>
<ul class="sectlevel2">
<li><a href="#backup-restore_backup-restore">19.1. Backup and Restore CRs</a></li>
<li><a href="#backing-up-clusters_backup-restore">19.2. Backing up Infinispan clusters</a></li>
<li><a href="#restoring-clusters_backup-restore">19.3. Restoring Infinispan clusters</a></li>
<li><a href="#backup-restore-status_backup-restore">19.4. Backup and restore status</a>
<ul class="sectlevel3">
<li><a href="#handling-failed-backups_backup-restore">19.4.1. Handling failed backup and restore operations</a></li>
</ul>
</li>
</ul>
</li>
<li><a href="#deploying-code">20. Deploying custom code to Infinispan</a>
<ul class="sectlevel2">
<li><a href="#copying-code_custom-code">20.1. Copying code artifacts to Infinispan clusters</a></li>
<li><a href="#downloading-code_custom-code">20.2. Downloading code artifacts</a></li>
</ul>
</li>
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.3</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.4</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.7</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.9</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.10</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.11</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.12</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">2.4.15</p></td>
<td class="tableblock halign-left valign-top"><div class="content"><div class="paragraph">
<p>14.0.1
14.0.6
14.0.9
...
<td class="content">
<div class="paragraph">
<p>Operand versions <code>15.1.0</code> and <code>15.1.1</code> should be skipped when upgrading from the <code>15.0.x</code> stream,
due to <a href="https://github.com/infinispan/infinispan/issues/13519">#13519</a> which may cause issues if invalidation caches are present or if attempting to restore from backups created with prior Infinispan versions.</p>
</div>
</td>
</tr>
</table>
...
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code>kubectl infinispan install --channel=stable
...
<div class="sectionbody">
<div class="paragraph _abstract">
<p>Use Infinispan Operator to create clusters of Data Grid Service pods.</p>
</div>
<div class="sect2">
...
Infinispan operator supports only <code>DataGrid</code> service type which deploys Infinispan clusters with full configuration and capabilities. <code>Cache</code> service type is no longer supported.</p>
</div>
<div class="paragraph">
<p>DataGrid` service type for clusters lets you:</p>
</div>
<div class="ulist">
<ul>
<li>
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock"><code>spec.scheduling.affinity</code></p></td>
...
<p>When you create caches, Infinispan permanently stores their configuration so your caches are available after cluster restarts.</p>
</div>
<div class="paragraph">
...
<div class="sect2">
<h3 id="configuring-pod-probesservices"><a class="anchor" href="#configuring-pod-probesservices"></a>7.6. Configuring pod probes</h3>
<div class="paragraph _abstract">
<p>Optionally configure the values of the Liveness, Readiness and Startup probes used by Infinispan pods.</p>
</div>
<div class="paragraph">
<p>The Infinispan Operator automatically configures the probe values to sensible defaults. We only recommend providing your own
values once you have determined that the default values do not match your requirements.</p>
</div>
<div class="olist arabic">
<div class="title">Procedure</div>
<ol class="arabic">
<li>
<p>Configure probe values using the <code>spec.service.container.*Probe</code> fields:</p>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-yaml" data-lang="yaml">spec:
  service:
...
<td class="content">
<div class="paragraph">
<p>If no value is specified for a given probe value, then the Infinispan Operator default is used.</p>
</div>
</td>
</tr>
</table>
...
<div class="sect2">
<h3 id="configuring-pod-priority_services"><a class="anchor" href="#configuring-pod-priority_services"></a>7.7. Configuring pod priority</h3>
<div class="paragraph _abstract">
...
<code>%d{HH:mm:ss,SSS} %-5p (%t) [%c] %m%throwable%n</code></p>
</div>
<div class="olist arabic">
<div class="title">Procedure</div>
<ol class="arabic">
<li>
<p>Configure Infinispan logging with the <code>spec.logging.pattern</code> field in your <code>Infinispan</code> CR.</p>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code>spec:
  logging:
    pattern: %X{address} %X{user} [%d{dd/MMM/yyyy:HH:mm:ss Z}]</code></pre>
</div>
</div>
</li>
<li>
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock"><code>&lt;cluster_name&gt;-admin</code></p></td>
<td class="tableblock halign-left valign-top"><p class="tableblock"><code>11223</code></p></td>
<td class="tableblock halign-left valign-top"><p class="tableblock">TCP</p></td>
<td class="tableblock halign-left valign-top"><p class="tableblock">Access to Infinispan endpoints within the Kubernetes cluster for internal Infinispan Operator use. This port utilises a different
security-realm to port 11222 and should not be accessed by user applications.</p></td>
</tr>
<tr>
...
<td class="content">
The Infinispan Console should only be accessed via Kubernetes services or an OpenShift <code>Route</code> exposing port 11222.
</td>
</tr>
</table>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code>oc create sa -n &lt;namespace&gt; lon</code></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code>oc policy add-role-to-user view -n &lt;namespace&gt; -z lon</code></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code>oc adm policy add-cluster-role-to-user cluster-reader -z lon -n &lt;namespace&gt;</code></pre>
</div>
</div>
</li>
<li>
...
<div class="sect3">
<h4 id="exchanging-service-account-tokens-cross-site"><a class="anchor" href="#exchanging-service-account-tokens-cross-site"></a>13.2.2. Exchanging service account tokens</h4>
<div class="paragraph _abstract">
<p>Generate service account tokens on your OpenShift clusters and add them into secrets at each backup location.
The tokens that you generate in this procedure do not expire.
For bound service account tokens, see <a href="#exchanging-bound-service-account-tokens-cross-site">Exchanging bound service account tokens</a>.</p>
</div>
<div class="ulist">
<div class="title">Prerequisites</div>
<ul>
...
<li>
<p>Create a service account token secret file as follows:</p>
<div class="listingblock">
<div class="title">sa-token.yaml</div>
<div class="content">
<pre class="highlight nowrap"><code class="language-yaml" data-lang="yaml">apiVersion: v1
kind: Secret
metadata:
  ...
  annotations:
    kubernetes.io/service-account.name: "&lt;service-account&gt;" <i class="conum" data-value="2"></i><b>(2)</b>
...
<td>Specifies the name of the secret.</td>
</tr>
<tr>
<td><i class="conum" data-value="2"></i><b>2</b></td>
<td>Specifies the service account name.</td>
</tr>
</table>
</div>
</li>
<li>
<p>Create the secret in your OpenShift cluster:</p>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code class="language-bash" data-lang="bash">oc -n &lt;namespace&gt; create -f sa-token.yaml</code></pre>
</div>
</div>
</li>
<li>
<p>Retrieve the service account token:</p>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code class="language-bash" data-lang="bash">oc -n &lt;namespace&gt; get secrets ispn-xsite-sa-token -o jsonpath="{.data.token}" | base64 -d</code></pre>
</div>
</div>
<div class="paragraph">
<p>The command prints the token in the terminal.</p>
</div>
</li>
<li>
<p>Copy the token for deployment in the backup OpenShift cluster.</p>
</li>
<li>
<p>Log in to the backup OpenShift cluster.</p>
</li>
<li>
<p>Add the service account token for a backup location:</p>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code class="language-bash" data-lang="bash">oc -n &lt;namespace&gt; create secret generic &lt;token-secret&gt; --from-literal=token=&lt;token&gt;</code></pre>
</div>
</div>
<div class="paragraph">
<p>The <code>&lt;token-secret&gt;</code> is the name of the secret configured in the <code>Infinispan</code> CR.</p>
</div>
</li>
</ol>
</div>
...
<ul>
<li>
<p><a href="https://docs.openshift.com/container-platform/4.14/nodes/pods/nodes-pods-secrets.html#nodes-pods-secrets-creating-sa_nodes-pods-secrets">Creating a service account token secret</a></p>
</li>
</ul>
</div>
</div>
<div class="sect3">
<h4 id="exchanging-bound-service-account-tokens-cross-site"><a class="anchor" href="#exchanging-bound-service-account-tokens-cross-site"></a>13.2.3. Exchanging bound service account tokens</h4>
<div class="paragraph _abstract">
<p>Create service account tokens with a limited lifespan and add them into secrets at each backup location.
You must refresh the token periodically to prevent Infinispan Operator from losing access to the remote OpenShift cluster.
For non-expiring tokens, see <a href="#exchanging-service-account-tokens-cross-site">Exchanging service account tokens</a>.</p>
</div>
<div class="ulist">
<div class="title">Prerequisites</div>
<ul>
...
<li>
<p>Create a bound token for the service account:</p>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code class="language-bash" data-lang="bash">oc -n &lt;namespace&gt; create token &lt;service-account&gt;</code></pre>
</div>
</div>
<div class="admonitionblock note">
<table>
...
<td class="content">
<div class="paragraph">
<p>By default, service account tokens are valid for one hour.
Use the command option <code>--duration</code> to specify the lifespan in seconds..</p>
</div>
</td>
</tr>
</table>
...
<li>
<p>Copy the token for deployment in the backup OpenShift cluster(s).</p>
</li>
<li>
<p>Log in to the backup OpenShift cluster.</p>
</li>
...
<li>
<p>Repeat the steps on other OpenShift clusters.</p>
</li>
</ol>
</div>
<h5 id="_deleting_expired_tokens" class="discrete">Deleting expired tokens</h5>
<div class="paragraph">
<p>When a token expires, delete the expired token secret, and then repeat the procedure to generate and exchange a new one.</p>
</div>
<div class="olist arabic">
<ol class="arabic">
<li>
...
<li>
<p>Delete the expired secret <code>&lt;token-secret&gt;</code>:</p>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code class="language-bash" data-lang="bash">oc -n &lt;namespace&gt; delete secrets &lt;token-secret&gt;</code></pre>
</div>
</div>
</li>
<li>
<p>Repeat the procedure to create a new token and generate a new <code>&lt;token-secret&gt;</code>.</p>
</li>
</ol>
</div>
<div class="ulist _additional-resources">
...
<ul>
<li>
<p><a href="https://docs.openshift.com/container-platform/4.14/authentication/bound-service-account-tokens.html#bound-sa-tokens-configuring-externally_bound-service-account-tokens">Creating bound service account tokens</a></p>
</li>
</ul>
</div>
</div>
<div class="sect3">
<h4 id="applying-cluster-roles-xsite_cross-site"><a class="anchor" href="#applying-cluster-roles-xsite_cross-site"></a>13.2.4. Setting up Kubernetes for managed cross-site connections</h4>
<div class="paragraph _abstract">
...
<div class="sect3">
<h4 id="configuring-sites-automatically_cross-site"><a class="anchor" href="#configuring-sites-automatically_cross-site"></a>13.2.5. Configuring managed cross-site connections</h4>
<div class="paragraph _abstract">
...
<li>
<p>Have a PKCS12 trust store that contains part of the certificate chain or root CA certificate that verifies public certificates for Infinispan relay pods and router pods.</p>
</li>
</ul>
</div>
<div class="olist arabic">
...
<li>
<p>Create trust store secrets.</p>
</li>
</ol>
</div>
</li>
...
<td class="tableblock halign-left valign-top"><p class="tableblock">Specifies the TLS protocol to use for cross-site connections. The default value is <code>TLSv1.3</code> but you can set <code>TLSv1.2</code> if required.</p></td>
</tr>
<tr>
...
<td class="tableblock halign-left valign-top"><p class="tableblock">Configures a trust store secret for relay pods and router pods.</p></td>
</tr>
</tbody>
</table>
<table class="tableblock frame-all grid-all stripes-even stretch">
...
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock"><code>secretName</code></p></td>
<td class="tableblock halign-left valign-top"><p class="tableblock">Specifies the secret that contains a trust store to verify public certificates for relay pods and router pods.
This field is required.</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock"><code>filename</code></p></td>
...
<div class="paragraph _abstract">
<p>Cross-site replication encryption secrets add keystores and trust store for securing cross-site connections.</p>
</div>
<div class="listingblock">
...
<ol class="arabic">
<li>
<p>Add the <code>spec.scheduling.affinity</code> block to your <code>Infinispan</code> CR.</p>
</li>
<li>
...
<div class="paragraph">
<p>The following is the anti-affinity strategy that Infinispan Operator uses if you do not configure the <code>spec.scheduling.affinity</code> field in your <code>Infinispan</code> CR:</p>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code class="language-yaml" data-lang="yaml">spec:
...
<div class="sect1">
<h2 id="auto-scaling"><a class="anchor" href="#auto-scaling"></a>16. Auto Scaling</h2>
<div class="sectionbody">
<div class="paragraph _abstract">
<p>Kubernetes includes the <code>HorizontalPodAutoscaler</code> which allows StatefulSets or Deployments to be automatically scaled up or
down based upon specified metrics. The Infinispan CR exposes the <code>.status.scale</code> sub-resource, which enables <code>HorizontalPodAutoscaler</code>
resources to target the Infinispan CR.</p>
</div>
<div class="paragraph">
<p>Before defining a <code>HorizontalPodAutoscaler</code> configuration, consider the types of Infinispan caches that you define. Distributed
and Replicated caches have very different scaling requirements, so defining a <code>HorizontalPodAutoscaler</code> for server&#8217;s running
a combination of these cache types may not be advantageous. For example, defining a <code>HorizontalPodAutoscaler</code> that scales
...
entries. Conversely, configuring a <code>HorizontalPodAutoscaler</code> based upon CPU usage will be more beneficial for clusters
with replicated cache as every pod contains all cache entries and so distributing read requests across additional nodes
will allow a greater number of requests to be processed simultaneously.</p>
</div>
<div class="sect2">
<h3 id="configuring_auto-scaling-scaling"><a class="anchor" href="#configuring_auto-scaling-scaling"></a>16.1. Configuring HorizontalPodAutoscaler</h3>
<div class="paragraph _abstract">
<p>Create a HorizontalPodAutoScaler resource that targets your Infinispan CR.</p>
</div>
<div class="olist arabic">
<div class="title">Procedure</div>
<ol class="arabic">
<li>
<p>Define a <code>HorizontalPodAutoscaler</code> resource in the same namespace as your <code>Infinispan</code> CR</p>
<div class="listingblock">
<div class="content">
<pre class="highlight nowrap"><code>apiVersion: autoscaling/v2
...
spec:
  scaleTargetRef:
    apiVersion: infinispan.org/v1
    kind: Infinispan
    name: example <i class="conum" data-value="1"></i><b>(1)</b>
  minReplicas: 1
  maxReplicas: 10
  metrics:
    - type: Resource
...
<tr>
<td><i class="conum" data-value="1"></i><b>1</b></td>
<td>The name of your <code>Infinispan</code> CR</td>
</tr>
</table>
</div>
</li>
...
<td class="content">
If using metric resource of type <code>cpu</code> or <code>memory</code>, you must configure request/limits for this resource in your <code>Infinispan</code> CR.
</td>
</tr>
</table>
</div>
...
<td class="content">
HorizontalPodAutoscaler should be removed when upgrading a Infinispan cluster, as the automatic scaling will
...
<div class="sect1">
<h2 id="creating-caches"><a class="anchor" href="#creating-caches"></a>17. Creating caches with Infinispan Operator</h2>
<div class="sectionbody">
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="caches_creating-caches"><a class="anchor" href="#caches_creating-caches"></a>17.1. Infinispan caches</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="creating-caches_creating-caches"><a class="anchor" href="#creating-caches_creating-caches"></a>17.2. Creating caches with the Cache CR</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="updating_cache_creating-caches"><a class="anchor" href="#updating_cache_creating-caches"></a>17.3. Updating caches with the Cache CR</h3>
<div class="paragraph">
...
<div class="sect2">
<h3 id="adding-cache-stores_creating-caches"><a class="anchor" href="#adding-cache-stores_creating-caches"></a>17.4. Adding persistent cache stores</h3>
<div class="paragraph _abstract">
...
<div class="sect1">
<h2 id="batch-cr"><a class="anchor" href="#batch-cr"></a>18. Running batch operations</h2>
<div class="sectionbody">
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="batching-inline_batch"><a class="anchor" href="#batching-inline_batch"></a>18.1. Running inline batch operations</h3>
<div class="paragraph _abstract">
...
spec:
  cluster: infinispan
  config: |
    create counter --concurrency-level=1 --initial-value=5 --storage=VOLATILE --type=weak batch-counter</code></pre>
</div>
</div>
</li>
</ol>
...
<div class="sect2">
<h3 id="batching-create-configmap_batch"><a class="anchor" href="#batching-create-configmap_batch"></a>18.2. Creating ConfigMaps for batch operations</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="batching-configmap_batch"><a class="anchor" href="#batching-configmap_batch"></a>18.3. Running batch operations with ConfigMaps</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="batch-status_batch"><a class="anchor" href="#batch-status_batch"></a>18.4. Batch status messages</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="batch-operations_batch"><a class="anchor" href="#batch-operations_batch"></a>18.5. Example batch operations</h3>
<div class="paragraph _abstract">
...
<div class="sect3">
<h4 id="_caches"><a class="anchor" href="#_caches"></a>18.5.1. Caches</h4>
<div class="ulist">
<ul>
<li>
...
<div class="sect3">
<h4 id="_counters"><a class="anchor" href="#_counters"></a>18.5.2. Counters</h4>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_protobuf_schema"><a class="anchor" href="#_protobuf_schema"></a>18.5.3. Protobuf schema</h4>
<div class="paragraph">
...
<div class="sect3">
<h4 id="_tasks"><a class="anchor" href="#_tasks"></a>18.5.4. Tasks</h4>
<div class="paragraph">
...
<div class="sect1">
<h2 id="backing-up-restoring"><a class="anchor" href="#backing-up-restoring"></a>19. Backing up and restoring Infinispan clusters</h2>
<div class="sectionbody">
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="backup-restore_backup-restore"><a class="anchor" href="#backup-restore_backup-restore"></a>19.1. Backup and Restore CRs</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="backing-up-clusters_backup-restore"><a class="anchor" href="#backing-up-clusters_backup-restore"></a>19.2. Backing up Infinispan clusters</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="restoring-clusters_backup-restore"><a class="anchor" href="#restoring-clusters_backup-restore"></a>19.3. Restoring Infinispan clusters</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="backup-restore-status_backup-restore"><a class="anchor" href="#backup-restore-status_backup-restore"></a>19.4. Backup and restore status</h3>
<div class="paragraph _abstract">
...
<div class="sect3">
<h4 id="handling-failed-backups_backup-restore"><a class="anchor" href="#handling-failed-backups_backup-restore"></a>19.4.1. Handling failed backup and restore operations</h4>
<div class="paragraph _abstract">
...
<div class="sect1">
<h2 id="deploying-code"><a class="anchor" href="#deploying-code"></a>20. Deploying custom code to Infinispan</h2>
<div class="sectionbody">
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="copying-code_custom-code"><a class="anchor" href="#copying-code_custom-code"></a>20.1. Copying code artifacts to Infinispan clusters</h3>
<div class="paragraph _abstract">
...
<div class="sect2">
<h3 id="downloading-code_custom-code"><a class="anchor" href="#downloading-code_custom-code"></a>20.2. Downloading code artifacts</h3>
<div class="paragraph _abstract">
...
infinispan.client.hotrod.cache.another-cache.configuration_uri=file:/path/to/configuration.xml</code></pre>
</div>
</div>
</div>
</div>
...
<div id="footer">
<div id="footer-text">
Last updated 2025-08-26 09:04:24 UTC
</div>
</div>
<script>
