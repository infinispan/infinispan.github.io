...
The demo aims to proof:

* the overall maturity of the client;
* the easiness of usage; (stardard nuget packaging)
* supports concurrency; (based on non blocking core)
* supports language neutral data types; (Protobuf data definition)
